...
const About = () => {
  return (
    <section className="container mx-auto px-6 py-20 max-w-7xl flex  gap-10 flex-col md:flex-row items-center justify-between sm:flex-col-reverse md:pt-30">
      <div className="mb-12 md:mb-0 md:w-1/2">
        <img
          src="./public/img/About/about-banner.webp"
      ...
      <div className="max-w-xl">
        ...
        <h2 className="text-2xl md:text-4xl font-semibold text-gray-800 leading-snug mb-6">
