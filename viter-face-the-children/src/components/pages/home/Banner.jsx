  ...
  return (
    <section className="container mx-auto px-6 py-20 max-w-7xl flex flex-col-reverse md:flex-row items-center justify-between">
        <div className="max-w-xl">
          ...
          <h2 className="text-4xl md:text-5xl font-semibold text-gray-800 leading-snug mb-6">
        ...
        <div className="mb-12 md:mb-0 md:w-1/2">
          <img src="https://facethechildren.org/images/website/h-banner.webp" alt="Creating Opportunity Image" className="w-full max-w-md mx-auto" />
        </div>
      </section>
  )
}
